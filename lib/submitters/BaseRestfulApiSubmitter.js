...
export default class BaseRestfulApiSubmitter {
  ...
  /**
   * get: Validation reference for this form clerk.
   *
   * @returns {import('vue').Ref<furo.ValidatorHashType>} - The validation reference.
   */
  get validationRef () {
  ...
  /**
   * get: RESTful API capsule reference.
   *
   * @returns {import('vue').Ref<import('~/lib/clients/RestfulApiClient.js').default>} - The capsule reference.
   */
  get capsuleRef () {
    return /** @type {*} */ (
