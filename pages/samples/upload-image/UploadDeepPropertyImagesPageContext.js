...
/**
 * Props context class for UploadDeepPropertyImagesPageContext component.
 *
 ...
 */
export default class UploadDeepPropertyImagesPageContext extends BaseFuroContext {
  /**
   * Constructor.
   *
   * @param {UploadDeepPropertyImagesPageContextParams} params - Parameters of this constructor.
   */
  constructor ({
    props,
    componentContext,
   ...
   *
   * @template {X extends typeof UploadDeepPropertyImagesPageContext ? X : never} T, X
   * @override
   * @param {UploadDeepPropertyImagesPageContextFactoryParams} params - Parameters of this factory method.
 ...
 * }} UploadDeepPropertyImagesPageContextParams
 */

/**
 * @typedef {UploadDeepPropertyImagesPageContextParams} UploadDeepPropertyImagesPageContextFactoryParams
 */
